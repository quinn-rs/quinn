...
pub struct Connection {
    ...
    version: u32,
    /// True if we emitted the event for received TLS13 tickets
...
impl Connection {
    ...
    fn read_crypto(
        ...
        if !self.resumption_tickets_received
            && self.crypto.tls13_session_tickets_received() > Some(0)
        {
...
pub enum Event {
    ...
    DatagramsUnblocked,
    /// One or more TLS13 resumption tickets have been received.
    ///
