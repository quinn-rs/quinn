...
fn pad_to_mtu() {
    ...
    // Check padding
    assert_eq!(pair.client.outbound.len(), 2);
    assert_eq!(pair.client.outbound[0].0.size, MTU.into());
    assert_eq!(pair.client.outbound[0].1.len(), MTU.into());
    assert_eq!(pair.client.outbound[1].0.size, MTU.into());
    assert_eq!(pair.client.outbound[1].1.len(), MTU.into());
    pair.drive_client();
    assert_eq!(pair.server.inbound.len(), 2);
    assert_eq!(pair.server.inbound[0].2.len(), MTU.into());
    assert_eq!(pair.server.inbound[1].2.len(), MTU.into());
    pair.drive();
