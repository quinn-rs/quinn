//! Unified NAT Traversal P2P Node
//!
//! A unified binary where each node can act as both:
...
#[derive(Parser, Debug)]
#[command(name = "nat-p2p-node")]
#[command(about = "Unified NAT Traversal P2P Node - Client + Coordinator")]
struct Args {
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let config = NodeConfig {
        enable_coordinator: !args.no_coordinator,
