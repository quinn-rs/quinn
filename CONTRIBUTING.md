...
[open a draft security advisory](https://github.com/quinn-rs/quinn/security/advisories/new)
...
prefer to `use std::error::Error as StdError`.

### Comments

Crate items should have descriptive documentation comments on them. These are required for
any publicly exposed items.

All comments (documentation comments or not) should be wrapped to 100 columns.

In addition to the conventions above, all documentation comments should conform to
