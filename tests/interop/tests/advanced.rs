...
async fn test_0rtt(
    ...
    metrics.insert("0rtt_handshake_ms".to_string(), rtt_handshake_time.as_millis() as f64);
...
async fn test_connection_migration(
    ...
    metrics.insert("migration_time_ms".to_string(), migration_time.as_millis() as f64);
...
async fn test_ecn(
    ...
    metrics.insert("ecn_transfer_ms".to_string(), ecn_test_time.as_millis() as f64);
    metrics.insert("ecn_throughput_mbps".to_string(),
...
mod tests {
    ...
    async fn test_advanced_features_framework() {
        ...
        let result = test_0rtt(&endpoint, "test.example.com:443").await;
