...
async fn test_transport_parameters(
    ...
    metrics.insert("handshake_ms".to_string(), handshake_time.as_millis() as f64);
...
async fn test_frame_types(
    ...
    metrics.insert("stream_frame_ms".to_string(), stream_test_time.as_millis() as f64);
    ...
    metrics.insert("max_streams_frame_ms".to_string(), max_streams_time.as_millis() as f64);
...
async fn test_error_codes(
    ...
    metrics.insert("stability_test_ms".to_string(), stability_time.as_millis() as f64);
...
mod tests {
    ...
    async fn test_extensions_framework() {
        ...
        let result = test_transport_parameters(&endpoint, "test.example.com:443").await;
