...
# quinn-perf server arguments
QUINN_PERF_DEFAULT_ARGS="--keylog --listen 172.42.0.2:4433"
...
echo "Launching quinn perf server with arguments: ${QUINN_PERF_DEFAULT_ARGS} ${QUINN_PERF_EXTRA_ARGS}"
docker compose exec -d ${SERVICE} /root/quinn-perf server ${QUINN_PERF_DEFAULT_ARGS} ${QUINN_PERF_EXTRA_ARGS}
