...
#[cfg(all(not(wasm_browser), any(feature = "aws-lc-rs", feature = "ring"), feature = "production-ready"))]
...
impl Endpoint {
    ...
    #[cfg(all(not(wasm_browser), any(feature = "aws-lc-rs", feature = "ring"), feature = "production-ready"))] // `EndpointConfig::default()` is only available with these
