...
impl LogFilterBuilder {
    ...
    pub fn quic_defaults(mut self) -> Self {
        self.filter.component_levels.insert("ant_quic::connection".to_string(), Level::DEBUG);
        self.filter.component_levels.insert("ant_quic::endpoint".to_string(), Level::INFO);
        self.filter.component_levels.insert("ant_quic::frame".to_string(), Level::TRACE);
        self.filter.component_levels.insert("ant_quic::packet".to_string(), Level::TRACE);
        self.filter.component_levels.insert("ant_quic::crypto".to_string(), Level::DEBUG);
        self.filter.component_levels.insert("ant_quic::transport_params".to_string(), Level::DEBUG);
        self
    }
    
    /// Configure for debugging NAT traversal
    pub fn nat_traversal_debug(mut self) -> Self {
        self.filter.component_levels.insert("ant_quic::nat_traversal".to_string(), Level::TRACE);
        self.filter.component_levels.insert("ant_quic::candidate_discovery".to_string(), Level::DEBUG);
        self.filter.component_levels.insert("ant_quic::connection::nat_traversal".to_string(), Level::TRACE);
        self
    }
    
    /// Configure for performance analysis
    pub fn performance_analysis(mut self) -> Self {
        self.filter.component_levels.insert("ant_quic::metrics".to_string(), Level::INFO);
        self.filter.component_levels.insert("ant_quic::congestion".to_string(), Level::DEBUG);
        self.filter.component_levels.insert("ant_quic::pacing".to_string(), Level::DEBUG);
        self
    }
    ...
    pub fn production(mut self) -> Self {
        ...
        self.filter.component_levels.insert("ant_quic::connection::lifecycle".to_string(), Level::INFO);
        self.filter.component_levels.insert("ant_quic::endpoint".to_string(), Level::INFO);
        self.filter.component_levels.insert("ant_quic::metrics".to_string(), Level::INFO);
        self
    }
...
impl DynamicLogFilter {
    ...
    /// Check if should log
    pub fn should_log(&self, target: &str, level: Level, message: &str) -> bool {
        self.inner.read().unwrap().should_log(target, level, message)
    }
...
mod tests {
    ...
    fn test_pattern_filtering() {
        let filter = LogFilter::new()
            .exclude_pattern(r"noisy").unwrap()
            .include_pattern(r"important.*noisy").unwrap();
