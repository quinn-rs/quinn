...
pub fn log_throughput_metrics(metrics: &ThroughputMetrics) {
    ...
    fields.insert("bytes_received".to_string(), metrics.bytes_received.to_string());
    fields.insert("packets_sent".to_string(), metrics.packets_sent.to_string());
    fields.insert("packets_received".to_string(), metrics.packets_received.to_string());
    fields.insert("duration_ms".to_string(), metrics.duration.as_millis().to_string());
...
pub fn log_latency_metrics(metrics: &LatencyMetrics) {
    ...
    fields.insert("min_rtt_ms".to_string(), metrics.min_rtt.as_millis().to_string());
    fields.insert("max_rtt_ms".to_string(), metrics.max_rtt.as_millis().to_string());
    fields.insert("smoothed_rtt_ms".to_string(), metrics.smoothed_rtt.as_millis().to_string());
