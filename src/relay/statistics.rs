...
use super::{
    RelayStatistics, SessionStatistics, ConnectionStatistics, 
    AuthenticationStatistics, RateLimitingStatistics, ErrorStatistics,
    SessionManager, RelayConnection,
};
...
impl RelayStatisticsCollector {
    ...
    fn collect_session_statistics(&self) -> SessionStatistics {
        ...
        for manager in managers.iter() {
            ...
            total_stats.total_bytes_forwarded += mgr_stats.total_bytes_sent + mgr_stats.total_bytes_received;
    ...
    fn collect_error_statistics(&self) -> ErrorStatistics {
        ...
        let total_errors = error_stats.protocol_errors + error_stats.resource_exhausted 
            + error_stats.session_errors + error_stats.auth_failures 
            + error_stats.network_errors + error_stats.internal_errors;
